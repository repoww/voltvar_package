...
from rllab.core.network import MLP2
from rllab.core.serializable import Serializable
from rllab.distributions.categorical2 import Categorical2
...
class CategoricalMLPPolicy2(StochasticPolicy, LasagnePowered):
    def __init__(
            self,
            env_spec,
            hidden_sizes=(32, 32),
    ...
    def get_action(self, observation, deterministic=False):
        ...
        if deterministic:
            action = self.action_space.determined_sample(prob)
        else:
