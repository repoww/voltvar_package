...
class RLAlgorithm(Algorithm):
    ...
    def __init__(
        ...
        self._n_epoch = int(n_epochs)
        self._n_train_repeat = n_train_repeat
        self._epoch_length = epoch_length
        self._n_initial_exploration_steps = n_initial_exploration_steps #(n_initial_exploration_steps//168+1)*168
    ...
    def _evaluate(self, epoch):
        ...
        total_violate = [sum([x['cost'] for x in path['env_infos']]) for path in paths]
