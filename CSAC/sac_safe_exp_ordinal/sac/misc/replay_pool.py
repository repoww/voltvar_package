...
class SimpleReplayPool(PoolBase, Serializable):
    def __init__(
        ...
        self._costs = np.zeros(max_pool_size)
    ...
    def add_sample(self, observation, action, reward, cost, terminal, final_state,
                   env_info=None):
    ...
    def add_path(self, observations, actions, rewards, costs, terminals, last_obs,
                 env_infos=None):
    ...
    def __setstate__(self, d):
        ...
        self._costs = np.fromstring(d['c']).reshape(self._max_pool_size)
