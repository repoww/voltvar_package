...
def load_flow(action,load):
    ...
    tsf_pos = {6: action[1]*0.05+1,  # from node 7 to node 8 line[6]
               25: action[2]*0.05+1,  # from node 19 to node 20 line[25]
    }
    cap_pos = {26: 0.01 + 0.01*action[3],   # 100KVA, base 5MVA, at node 27/node[26]
               28: 0.015 + 0.015*action[4],   # 150KVA, base 5MVA, at node 29/node[28]
    }
...
if __name__ == "__main__":
    Pij, Qij, Vi2, Lij, total_loss, iter, convergence_flag = load_flow([1,1,0,0,0],1)
    print(np.sqrt(Vi2))